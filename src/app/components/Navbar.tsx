    ...
    return (
        <div className="flex flex-row px-6 py-4 w-full justify-between items-center z-50">
            ...
            <ul className='hidden md:flex flex-row h-fit gap-6 font-lexend font-light items-center'>
                <li><Link href={'/'} className="text-white text-lg py-3 px-5 rounded-full hover:backdrop-blur-xl hover:bg-white/25">Home</Link></li>
                <li><Link href={'/#faq'} className="text-white text-lg py-3 px-5 rounded-full hover:backdrop-blur-xl hover:bg-white/25">FAQ</Link></li>
